<html lang="en-us"><head>
	...
	<title>Nazi Zombies: Portable</title>
  ...
  <script src="ftewebgl.js" type="text/javascript" charset="utf-8"></script></head>
  <body ondrop="gotdrop(event);" ondragover="event.preventDefault()">
	<div class="emscripten" id="status" hidden=""></div>
	<div id="dropzone" ondrop="gotdrop(event);" ondragover="event.preventDefault()" hidden="">Drop Zone</div>
	<button type="button" onclick="begin()" id="begin" hidden="">Click To Begin!</button>
	<div class="emscripten">
		<progress value="0" max="1" id="progress" hidden=""></progress>  
	</div>
	<canvas class="emscripten" id="canvas" oncontextmenu="event.preventDefault()" hidden="1" style="cursor: none;" width="1357" height="920"></canvas>
...
if (window.location.hash != "" || Object.keys(Module.files).length)
    ...
    <img src="https://hits.sh/hits.sh/nzp-team.github.io/latest/game.html/hits.svg" style="opacity:0;width:0px;" xhdqwzddp="">
